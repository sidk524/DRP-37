...
export async function getTetherSession() {
    ...
    return getRequiredTetherMethod("getSession")();
}
...
export async function getTetherOAuthRedirectUrl() {
    return getRequiredTetherMethod("getOAuthRedirectUrl")();
}

export async function tetherOAuthLogin(url) {
    return getRequiredTetherMethod("oauthLogin")(url);
}

export async function tetherWebServerRequest(payload) {
    return getRequiredTetherMethod("webServerRequest")(payload);
}
