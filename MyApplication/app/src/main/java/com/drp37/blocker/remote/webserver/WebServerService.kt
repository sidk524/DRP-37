...
object WebServerService {
    ...
    suspend fun reportAccountabilityAttempt(packageName: String, label: String) {
        val sessionId = com.drp37.blocker.local.TetherLocalStore.getActiveSession()?.sessionId ?: "none"
        ...
        request(
            ...
            body = JSONObject()
                ...
                .put("idempotencyKey", "$sessionId:$packageName:$minuteBucket")
        )
    }
    ...
    suspend fun markAccountabilityMessageRead(id: String) {
